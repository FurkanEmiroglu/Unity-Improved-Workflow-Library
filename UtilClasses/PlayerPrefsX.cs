...
namespace IW.UtilClasses
{
    public class PlayerPrefsX
    {
        ...
        public static bool[] GetBoolArray(string key, bool defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) boolArray[i] = defaultValue;
            return boolArray;
        }
        ...
        public static string[] GetStringArray(string key, string defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) stringArray[i] = defaultValue;
            return stringArray;
        }
        ...
        private static bool SetValue<T>(string key,
                                        T array,
                                        ArrayType arrayType,
                                        int vectorNumber,
                                        Action<T, byte[], int> convert) where T : IList
        {
            ...
            for (int i = 0; i < array.Count; i++) convert(array, bytes, i);
            return SaveBytes(key, bytes);
        }
        ...
        public static int[] GetIntArray(string key, int defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) intArray[i] = defaultValue;
            return intArray;
        }
        ...
        public static float[] GetFloatArray(string key, float defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) floatArray[i] = defaultValue;
            return floatArray;
        }
        ...
        public static Vector2[] GetVector2Array(string key, Vector2 defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) vector2Array[i] = defaultValue;
            return vector2Array;
        }
        ...
        public static Vector3[] GetVector3Array(string key, Vector3 defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) vector3Array[i] = defaultValue;
            return vector3Array;
        }
        ...
        public static Quaternion[] GetQuaternionArray(string key, Quaternion defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) quaternionArray[i] = defaultValue;
        ...
        public static Color[] GetColorArray(string key, Color defaultValue, int defaultSize)
        {
            ...
            for (int i = 0; i < defaultSize; i++) colorArray[i] = defaultValue;
            return colorArray;
        }

        private static void GetValue<T>(string key,
                                        T list,
                                        ArrayType arrayType,
                                        int vectorNumber,
                                        Action<T, byte[]> convert) where T : IList
        {
            if (PlayerPrefs.HasKey(key))
            {
                ...
                for (int i = 0; i < end; i++) convert(list, bytes);
            }
        }
        ...
        private static void Initialize()
        {
            ...
            if (s_byteBlock == null) s_byteBlock = new byte[4];
            s_idx = 1;
        }
        ...
        {
            s_byteBlock = BitConverter.GetBytes(f);
        ...
        private static float ConvertBytesToFloat(byte[] bytes)
        {
            ...
            return BitConverter.ToSingle(s_byteBlock, 0);
        }

        private static void ConvertInt32ToBytes(int i, byte[] bytes)
        {
            s_byteBlock = BitConverter.GetBytes(i);
            ConvertTo4Bytes(bytes);
        }
        ...
        {
            ConvertFrom4Bytes(bytes);
            return BitConverter.ToInt32(s_byteBlock, 0);
        }

        private static void ConvertTo4Bytes(byte[] bytes)
        {
            bytes[s_idx] = s_byteBlock[s_endianDiff1];
            bytes[s_idx + 1] = s_byteBlock[1 + s_endianDiff2];
            bytes[s_idx + 2] = s_byteBlock[2 - s_endianDiff2];
            bytes[s_idx + 3] = s_byteBlock[3 - s_endianDiff1];
            s_idx += 4;
        }

        private static void ConvertFrom4Bytes(byte[] bytes)
        {
            s_byteBlock[s_endianDiff1] = bytes[s_idx];
            s_byteBlock[1 + s_endianDiff2] = bytes[s_idx + 1];
            s_byteBlock[2 - s_endianDiff2] = bytes[s_idx + 2];
            s_byteBlock[3 - s_endianDiff1] = bytes[s_idx + 3];
            s_idx += 4;
        }
